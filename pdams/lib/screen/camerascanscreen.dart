...
class CameraScanScreen extends StatefulWidget {
  ...
  const CameraScanScreen({super.key, required this.user});
...
class _CameraScanScreenState extends State<CameraScanScreen> {
  ...
  Future<void> _performOCR() async {
    ...
    try {
      ...
      String modelId = 'a42dfd1f-3340-42fb-ac06-3cc9260ef918'; //patient model
...
//     _scannedData.forEach((key, appointmentData) {
//       String? appointmentName = appointmentData['AppointmentName'];
...
//       http.post(
//         Uri.parse("${MyConfig().SERVER}/pdams/php/check_availability.php"),
//         body: {
//           'icNumber': icNumber,
//           'date': date,
//           'time': time,
